@extends('layout')
@section('title', 'The CBL | Player Update')
@section('content')
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <form  enctype="multipart/form-data">
        <div class="container">
            <h1 class="text-center underLine">Player Update Information</h1>
        ...
        <div class="container">
            <div class="row g-sm-4 mt-0">
                <div class="col-sm-4">
                    ...
                    <input type="tel" name="whatsapp_num" maxlength="10" class="form-control" placeholder="Enter Mobile Number" value="{{old('whatsapp_num')}}" >
        ...
        <div class="container">
            <div class="row g-sm-4 mt-0">
                <div class="col-sm-4">
                    ...
                    <input type="date" name="dateOfBirth" class="form-control" placeholder="Enter Date of Birth" value="{{old('dateOfBirth')}}" >
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" name="pincode" id="pincode" class="form-control" placeholder="Enter Pincode"  onkeypress="getDetails()" / >
        ...
        <div class="container">
            ...
            <div class="row g-sm-4 mt-1">
                <div class="col-sm-4">
                    ...
                    <input type="number" name="height" class="form-control" placeholder="Enter Height in CM" value="{{old('height')}}" >
                     <span class="text-danger " >@error ('height') {{$message}} @enderror</span> 
                </div>
                <div class="col-sm-4">
                    <label for="weight" class="form-label">Weight (KG.) *</label>
                    <input type="number" name="weight" class="form-control" placeholder="Enter Weight in KG." value="{{old('weight')}}"  >
        ...
        <div class="container">
            <div class="row g-sm-4 mt-0">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="file" id="p_document" name="document" class="form-control" value="{{old('document')}}" >
                     <span class="text-danger " >@error ('document') {{$message}} @enderror</span> 
                </div>
                <div class="col-sm-4">
                    <label for="jersy" class="form-label">Prefered Jersey Number *</label>
                    <input type="number" name="jersy" id="p-jersy" class="form-control" placeholder="Enter Jersey Number" value="{{old('jersy')}}" >
        ...
        <div class="container">
            <div class="row g-sm-4 mt-0">
                <div class="col-sm-8">
                    ...
                    <textarea name="experiance"  class="form-control" rows="3" id="p_experiance" value="{{old('experiance')}}"  ></textarea>
                     <span class="text-danger col-sm-4" >@error ('experiance') {{$message}} @enderror</span> 
                </div>
                <div class="col-sm-4 ">
                    <input type="checkbox" id="check" name="termId"><label for="check" class="ms-1"> <h6>I accept All Term And Condition</h6></label>
        ...
        <div class="container mt-1 mb-2">
            <div class="row justify-content-between" >
                <div class="row g-3 justify-content-between">
                    <div class=" col-4 ">
                        <a onclick="location.href='{{ url('player') }}'"  class="btn btn-light fw-bolder col-sm-6">Back</a>
                    </div>
                    <div class="col-4 ">
                        <a type="submit" onclick="location.href='{{ url('dashboard') }}'" class="btn btn-light fw-bolder col-sm-6">Update</a>
                    </div>
                </div>
            </div>
        </div>

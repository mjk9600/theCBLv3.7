        ...
        <div class="container mt-3 mb-2">
            <div class="row g-3" >
                <div class=" row g-3 justify-content-between">
                    <div class=" col-4">
                        <a onclick="location.href='{{ url('tournament') }}'" class="btn btn-light Btn col-sm-6">Back</a>
                    </div>
                    <div class=" col-4"></div>
                    <div class=" col-4 ">
                        <a onclick="location.href='{{ url('dashboard') }}'"  class="btn btn-light Btn col-sm-6">Update</a>
                    </div>
                </div>
            </div>
        </div>

...
<body>
    <h1 class="text-center underLine">Tournament Information</h1>
...
{{ csrf_field() }}
        ...
        <div class=" row g-sm-4">
            ...
            <div class="col-sm-4">
                ...
                <input type="email" name="email" id="e-mail" class="form-control"  disabled>

            </div>
            <div class="col-sm-4">
                <label for="mobileNumber" class="form-label">Mobile Number *</label>
                <input type="tel" name="mobileNumber" id="mobileNumber" class="form-control"   disabled>
        ...
        <div class="container">
            ...
            <div class="row g-sm-4">
                <div class="col-sm-4">
                    <div class="picture-container">
                        <div class="picture form-floating">
                            ...
                            <input type="file" name="logo" id="wizard-picture" class="form-control" disabled>
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" name="tournament_name" id="mobileNumber" class="form-control" disabled>

                </div>
                <div class="col-sm-4">
                    <label for="tournament_location" class="form-label">Tournament Location *</label>
                    <input type="text" name="tournament_location" id="mobileNumber" class="form-control" disabled>
        ...
        <div class=" container mt-3">
            <div class="row g-sm-4">
                <div class="col-sm-8">
                    ...
                    <textarea name="aboutTournament" id="aboutTournament" class="form-control" rows="3"  disabled></textarea>
        ...
        <div class="container mt-3 mb-2">
            <div class="row g-3" >
                <div class=" row g-3 justify-content-between">
                    <div class=" col-4">
                    <!-- <a onclick="location.href='{{ url('tournamentUpdate') }}'" class="btn btn-light Btn col-sm-6"></a> -->
                    </div>
                    <div class=" col-4"></div>
                    <div class=" col-4 ">
                        <a onclick="location.href='{{ url('tournamentUpdate') }}'" class="btn btn-light Btn col-sm-6">Edit</a>
                    </div>
                </div>
            </div>
        </div>

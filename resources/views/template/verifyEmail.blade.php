                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p
                                            ...
                                            We've received a request to verification of your mail id.
                                            </p>
                                        <p
                                            style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                            You can verify your mail id by clicking the button below:
                                        </p>

                                        <p style="text-align: center;">
                                            <!-- <a href="{{'http://localhost:8000/loginPage/'.$user['token']}}" class="btn">Reset your password</a> -->
                                            
                                            <a href="{{'http://localhost:8000/loginPage/'.$user['token']" class="btn">Verify your mail</a>
